...
local tbModifier = tbTable:GetModifier("Lua_lingguo_mu");
...
function tbModifier:Enter(modifier, npc)
	...
	for i=1,15 do
		local buff = npc.PropertyMgr:FindModifier("Modifier_lingguo_mu"..i)
		if buff ~= nil then
...
function tbModifier:BuffJianCe(modifier)
	...
	local num = 0
	if name == "Modifier_lingguo_mu1" then
		num = 180*modifier.Scale
	elseif name == "Modifier_lingguo_mu2" then
		num = 360*modifier.Scale
	elseif name == "Modifier_lingguo_mu3" then
		num = 720*modifier.Scale
	elseif name == "Modifier_lingguo_mu4" then
		num = 1280*modifier.Scale
	elseif name == "Modifier_lingguo_mu5" then
		num = 1880*modifier.Scale
	elseif name == "Modifier_lingguo_mu6" then
		num = 2680*modifier.Scale
	elseif name == "Modifier_lingguo_mu7" then
		num = 3680*modifier.Scale
	elseif name == "Modifier_lingguo_mu8" then
		num = 4880*modifier.Scale
	elseif name == "Modifier_lingguo_mu9" then
		num = 6880*modifier.Scale
	elseif name == "Modifier_lingguo_mu10" then
		num = 9880*modifier.Scale
	elseif name == "Modifier_lingguo_mu11" then
