...
local tbModifier = tbTable:GetModifier("Lua_lingguo_huo");
...
function tbModifier:Enter(modifier, npc)
	...
	for i=1,15 do
		local buff = npc.PropertyMgr:FindModifier("Modifier_lingguo_huo"..i)
		if buff ~= nil then
...
function tbModifier:BuffJianCe(modifier)
	...
	local num = 0
	if name == "Modifier_lingguo_huo1" then
		num = 180*modifier.Scale
	elseif name == "Modifier_lingguo_huo2" then
		num = 360*modifier.Scale
	elseif name == "Modifier_lingguo_huo3" then
		num = 720*modifier.Scale
	elseif name == "Modifier_lingguo_huo4" then
		num = 1280*modifier.Scale
	elseif name == "Modifier_lingguo_huo5" then
		num = 1880*modifier.Scale
	elseif name == "Modifier_lingguo_huo6" then
		num = 2680*modifier.Scale
	elseif name == "Modifier_lingguo_huo7" then
		num = 3680*modifier.Scale
	elseif name == "Modifier_lingguo_huo8" then
		num = 4880*modifier.Scale
	elseif name == "Modifier_lingguo_huo9" then
		num = 6880*modifier.Scale
	elseif name == "Modifier_lingguo_huo10" then
		num = 9880*modifier.Scale
	elseif name == "Modifier_lingguo_huo11" then
