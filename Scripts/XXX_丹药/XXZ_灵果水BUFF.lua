...
local tbModifier = tbTable:GetModifier("Lua_lingguo_shui");
...
function tbModifier:Enter(modifier, npc)
	...
	for i=1,15 do
		local buff = npc.PropertyMgr:FindModifier("Modifier_lingguo_shui"..i)
		if buff ~= nil then
...
function tbModifier:BuffJianCe(modifier)
	...
	local num = 0
	if name == "Modifier_lingguo_shui1" then
		num = 180*modifier.Scale
	elseif name == "Modifier_lingguo_shui2" then
		num = 360*modifier.Scale
	elseif name == "Modifier_lingguo_shui3" then
		num = 720*modifier.Scale
	elseif name == "Modifier_lingguo_shui4" then
		num = 1280*modifier.Scale
	elseif name == "Modifier_lingguo_shui5" then
		num = 1880*modifier.Scale
	elseif name == "Modifier_lingguo_shui6" then
		num = 2680*modifier.Scale
	elseif name == "Modifier_lingguo_shui7" then
		num = 3680*modifier.Scale
	elseif name == "Modifier_lingguo_shui8" then
		num = 4880*modifier.Scale
	elseif name == "Modifier_lingguo_shui9" then
		num = 6880*modifier.Scale
	elseif name == "Modifier_lingguo_shui10" then
		num = 9880*modifier.Scale
	elseif name == "Modifier_lingguo_shui11" then
