...
local tbModifier = tbTable:GetModifier("Lua_lingguo_tu");
...
function tbModifier:Enter(modifier, npc)
	...
	for i=1,15 do
		local buff = npc.PropertyMgr:FindModifier("Modifier_lingguo_tu"..i)
		if buff ~= nil then
...
function tbModifier:BuffJianCe(modifier)
	...
	local num = 0
	if name == "Modifier_lingguo_tu1" then
		num = 180*modifier.Scale
	elseif name == "Modifier_lingguo_tu2" then
		num = 360*modifier.Scale
	elseif name == "Modifier_lingguo_tu3" then
		num = 720*modifier.Scale
	elseif name == "Modifier_lingguo_tu4" then
		num = 1280*modifier.Scale
	elseif name == "Modifier_lingguo_tu5" then
		num = 1880*modifier.Scale
	elseif name == "Modifier_lingguo_tu6" then
		num = 2680*modifier.Scale
	elseif name == "Modifier_lingguo_tu7" then
		num = 3680*modifier.Scale
	elseif name == "Modifier_lingguo_tu8" then
		num = 4880*modifier.Scale
	elseif name == "Modifier_lingguo_tu9" then
		num = 6880*modifier.Scale
	elseif name == "Modifier_lingguo_tu10" then
		num = 9880*modifier.Scale
	elseif name == "Modifier_lingguo_tu11" then
